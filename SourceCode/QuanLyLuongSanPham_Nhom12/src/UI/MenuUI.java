...
public class MenuUI extends JPanel implements ActionListener, MouseListener {
	...
	public void createGUI() {
		...
		mniTrangChu.setBorder(BorderFactory.createCompoundBorder(
		...
		mniPhongBan.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniHopDong.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mnSanPham.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniQuanLySP.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniTimKiemSP.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
...
//		mnCongDoan.add(mniTimKiemCD);
		...
		mnCongNhan.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniQuanLyCN.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniTimKiemCN.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniChamCongCN.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniTinhLuongCN.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mnNhanVien.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniQuanLyNV.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniTimKiem.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniPCNV.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniChamCongNV.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniTinhLuong.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniThongKe.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
		...
		mniCaiDat.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(read_file_themes.getString("color_main_sw"))),
				BorderFactory.createEmptyBorder(5, 15, 5, 15)));
...
//		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == mniPCNV) {
			...
			main.pnlContent.removeAll(); // Remove all nội dung
			main.pnlContent.add(new PhanCongNhanVienUI(main), BorderLayout.CENTER);// thêm giao diện phân công nhân viên
																					// vào
			main.validate(); // cập nhật lại
		}
		if (o == mniChamCongNV) {
